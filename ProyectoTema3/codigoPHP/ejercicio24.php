                ...
                ?>
                    <form name="formulario" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post"/>
						...
						<input type="text" name="nombre" 
								value="<?php if(isset($_POST["nombre"])&& is_null($aErrores["nombre"])){echo $_POST["nombre"];}?>"/> 
                        <label style="color: red;"><?php   echo $aErrores["nombre"]; ?>*</label><br><br>
                        
                        Introduzca sus apellidos:
						<input type="text" name="apellidos" 
							value="<?php if(isset($_POST["apellidos"])&& is_null($aErrores["apellidos"])){echo $_POST["apellidos"];}?>"/>
						...
						<input type="text" name="telefono"  
							value="<?php if(isset($_POST["telefono"])&& is_null($aErrores["telefono"])){echo $_POST["telefono"];}?>"/>
